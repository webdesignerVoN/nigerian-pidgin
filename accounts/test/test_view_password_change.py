...
class PasswordChangeTests(TestCase):
    def setUp(self):
        username = 'von'
        password = 'secret123'
        user = User.objects.create_user(username=username, email='von@yahoo.com', password=password)
...
class PasswordChangeTestCase(TestCase):
    ...
    def setUp(self, data={}):
        self.user = User.objects.create_user(username='von', email='von@yahoo.com', password='old_password')
        self.url = reverse('password_change')
        self.client.login(username='von', password='old_password')
